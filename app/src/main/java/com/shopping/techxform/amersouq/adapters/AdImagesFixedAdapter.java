...
import com.shopping.techxform.amersouq.fragments.ad_creation.FixedPriceFragment;
...
public class AdImagesFixedAdapter extends RecyclerView.Adapter<AdImagesFixedAdapter.ViewHolder> {

    private ArrayList<AdImagesModel> namelist = new ArrayList<>();
    private List<String> newlist = new ArrayList<>();
    HomeAdapter images_adapter;
    FixedPriceFragment fragment;
    Context context;

    Activity activity;

    public AdImagesFixedAdapter(ArrayList<AdImagesModel> namelist, Activity activity, Context context,FixedPriceFragment fragment) {
