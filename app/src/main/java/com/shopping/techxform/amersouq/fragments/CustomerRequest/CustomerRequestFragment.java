package com.shopping.techxform.amersouq.fragments.CustomerRequest;
...
import com.shopping.techxform.amersouq.adapters.CustomerRequestListAdapter;
...
public class CustomerRequestFragment extends Fragment {
    ...
    CustomerRequestListAdapter customerRequestListAdapter;
    Activity activity;
    Context context;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        customerRequestListAdapter = new CustomerRequestListAdapter(getActivity(), myOrdersLists);
        orders_list.setAdapter(customerRequestListAdapter);
    }
