...
public class CustomerRequestListAdapter extends RecyclerView.Adapter<CustomerRequestListAdapter.ViewHolder> {

    private Context mContext;
    private List<MyOrdersList> myOrdersLists;

    public CustomerRequestListAdapter(Context mContext, List<MyOrdersList> myOrdersLists) {
    ...
    @NonNull
    @Override
    public CustomerRequestListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext)
                .inflate(R.layout.layout_my_order_item, parent, false);

        return new CustomerRequestListAdapter.ViewHolder(itemView);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    @Override
    public void onBindViewHolder(@NonNull CustomerRequestListAdapter.ViewHolder holder, int position) {
...
//                    Intent intent = new Intent(mContext, ProductDetailsActivity
//                            .class);
