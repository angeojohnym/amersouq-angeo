...
import com.shopping.techxform.amersouq.RetrofitHelpers.Models.HomePageData.FeaturedProductsItem;
...
public class HomeFeaturedProductAdapter extends RecyclerView.Adapter<HomeFeaturedProductAdapter.ViewHolder> {

    private List<FeaturedProductsItem> namelist = new ArrayList<>();
    ...
    public HomeFeaturedProductAdapter(List<FeaturedProductsItem> namelist, Activity activity, Context context) {
        this.namelist = namelist;
        this.activity = activity;
        this.context = context;


    }  public HomeFeaturedProductAdapter(List<FeaturedProductsItem> namelist, Activity activity, Context context, RecyclerClick recyclerClick) {
        this.namelist = namelist;
        this.activity = activity;
        this.context = context;
    ...
    public List<FeaturedProductsItem> getStudentist() {
        return namelist;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.featured_pdt_list_item, parent, false);
...
//        holder.img_view.setText(namelist.get(position).getTitlename());
        ...
        holder.pdt_title.setText(namelist.get(position).getTitle());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mRecyclerClick!=null){
                    mRecyclerClick.onClickItem(v,position);
                }
            }
        });
        holder.pdt_desc.setText(namelist.get(position).getShortDescription());
...
//        holder.price_td.setPaintFlags(holder.price_td.getPaintFlags() Paint.UNDERLINE_TEXT_FLAG);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView img_view;
        TextView pdt_title,pdt_desc,price_td,offer_price_td;

        public ViewHolder(View itemView) {
            super(itemView);

            pdt_desc=(TextView)itemView.findViewById(R.id.pdt_desc);
            price_td=(TextView)itemView.findViewById(R.id.price_td);
            offer_price_td=(TextView)itemView.findViewById(R.id.offer_price_td);


            pdt_title=(TextView)itemView.findViewById(R.id.pdt_title);
