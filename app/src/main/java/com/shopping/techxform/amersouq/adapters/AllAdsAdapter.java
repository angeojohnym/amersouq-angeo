...
/**
 * Created by techxform on 01-Dec-18.
 */
...
public class AllAdsAdapter extends RecyclerView.Adapter<AllAdsAdapter.ViewHolder> {
    ...
    private List<AllAd> namelist = new ArrayList<>();
    ...
    public AllAdsAdapter(List<AllAd> namelist, Activity activity, int rowLayout, Context context, String type) {
    ...
    public List<AllAd> getStudentist() {
        return namelist;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final AllAd admodel=namelist.get(position);
