...
public class AllAdsAdapter_fixed extends RecyclerView.Adapter<AllAdsAdapter_fixed.ViewHolder> {

    private List<AllAd_Fixed> namelist = new ArrayList<>();
    ...
    public AllAdsAdapter_fixed(List<AllAd_Fixed> namelist, Activity activity, int rowLayout, Context context,String type) {
    ...
    public List<AllAd_Fixed> getStudentist() {
        return namelist;
    }

    @Override
    public AllAdsAdapter_fixed.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(rowLayout, parent, false);
        return new AllAdsAdapter_fixed.ViewHolder(v);

    }

    @Override
    public void onBindViewHolder(final AllAdsAdapter_fixed.ViewHolder holder, final int position) {


        final AllAd_Fixed admodel=namelist.get(position);
