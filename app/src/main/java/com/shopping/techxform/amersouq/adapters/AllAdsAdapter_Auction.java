...
public class AllAdsAdapter_Auction extends RecyclerView.Adapter<AllAdsAdapter_Auction.ViewHolder> {

    private List<AllAd_Auc> namelist = new ArrayList<>();
    ...
    public AllAdsAdapter_Auction(List<AllAd_Auc> namelist, Activity activity, int rowLayout, Context context, String type) {
    ...
    public List<AllAd_Auc> getStudentist() {
        return namelist;
    }
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        final AllAd_Auc admodel=namelist.get(position);
