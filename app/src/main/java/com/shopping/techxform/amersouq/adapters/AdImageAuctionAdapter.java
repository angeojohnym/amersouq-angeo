...
public class AdImageAuctionAdapter extends RecyclerView.Adapter<AdImageAuctionAdapter.ViewHolder> {
    ...
    public AdImageAuctionAdapter(ArrayList<AdImagesModel> namelist, Activity activity, Context context,AuctionFragment fragment) {
